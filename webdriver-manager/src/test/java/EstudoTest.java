...
public class EstudoTest {
    ...
    public void testCadastroSimplesComDadosValidos() {
        String nomeDinamico = "user_" + UUID.randomUUID().toString().substring(0, 6);
        String emailDinamico = nomeDinamico + "@teste.com";
        assertThat(driver.findElement(By.linkText("Cadastre-se")).getText(), is("Cadastre-se"));
        driver.findElement(By.linkText("Cadastre-se")).click();
        driver.findElement(By.id("nome")).sendKeys(nomeDinamico);
        driver.findElement(By.id("email")).sendKeys(emailDinamico);
